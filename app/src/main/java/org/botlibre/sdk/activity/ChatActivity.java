...
//		Toast.makeText(this, Uid, Toast.LENGTH_SHORT).show();
		...
		history.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent is = new Intent(ChatActivity.this,UserHistoryActivity.class);
				startActivity(is);
			}
		});
			...
			public void onClick(View v) {
				...
				builder.setMessage("Are you sure you want to Log out ?").setCancelable(true).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialogInterface, int i) {
						...
						MainActivity.post = null;
						MainActivity.posts = new ArrayList<ForumPostConfig>();
						MainActivity.instances = new ArrayList<WebMediumConfig>();
						MainActivity.domain = null;
						MainActivity.tags = null;
						MainActivity.categories = null;
						MainActivity.learning = null;
						MainActivity.voice = null;
						...
						HttpGetImageAction.clearFileCache(ChatActivity.this);


						FirebaseAuth.getInstance().signOut();


						Intent intent3 = new Intent(ChatActivity.this, InitsActivity.class);
	...
	public void submitChat() {
		...
		Timestamp = String.valueOf(Tstamp);
		reference.child(Uid).child("ChatHistory").child(Timestamp).child("Question").setValue(config.message);
		...
		try {
			...
			list.post(new Runnable() {
				...
				public void run() {
					if(Timestamp != null)
					{
						reference.child(Uid).child("ChatHistory").child(Timestamp).child("Answer").setValue(response.message);
